import TreadmillBanner from './assets/TreadmilBanner.png'
...
const Treadmill = () => {
    ...
    const timeTarget = 31 * 60; 
    const caloriesTarget = 205;
    ...
    return (
      <section className="Exercise_banner">
        <div className="Exercise_banner__left-side">
          ...
          <p className="Exercise_banner__title">Treadmill Exercise</p>
        ...
        <div className="Exercise_banner__right-side">
          <img src={TreadmillBanner} alt="Treadmill Banner" />
