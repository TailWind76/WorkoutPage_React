import StretchingBanner from './assets/StretchingBanner.png'
...
const Stretching = () => {
    ...
    const timeTarget = 20 * 60; 
    const caloriesTarget = 120;
    ...
    return (
      <section className="Exercise_banner">
        <div className="Exercise_banner__left-side">
          ...
          <p className="Exercise_banner__title">Stretching Exercise</p>
        ...
        <div className="Exercise_banner__right-side">
          <img src={StretchingBanner} alt="Treadmill Banner" />
