import liftingBanner from './assets/liftingBanner.png'
    ...
    return (
      <section className="Exercise_banner">
        <div className="Exercise_banner__left-side">
          ...
          <p className="Exercise_banner__title">Lifting Exercise</p>
        ...
        <div className="Exercise_banner__right-side">
          <img src={liftingBanner} alt="Treadmill Banner" />
