import runningBanner from './assets/runningBanner.png'
    ...
    return (
      <section className="Exercise_banner">
        <div className="Exercise_banner__left-side">
          ...
          <p className="Exercise_banner__title">Running Exercise</p>
        ...
        <div className="Exercise_banner__right-side">
          <img src={runningBanner} alt="Treadmill Banner" />
